...
const apiRoutes = [
  ...
  { path: '/api/moyens-generaux/categories-accessoire', route: require('./routes/categorieAccessoire.routes') },
  { path: '/api/moyens-generaux/regles-distribution', route: require('./routes/regleDistribution.routes') },
  { path: '/api/moyens-generaux/demandes-surplus', route: require('./routes/demandeSurplus.routes') },
  { path: '/api/moyens-generaux/transferts', route: require('./routes/transfertStock.routes') },
