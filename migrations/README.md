...
| `2026-08-25_retrait_decomptes_figes.sql` | Commentaires seuls. Retire les decomptes dates du 15 aout des 73 commentaires de vues : ils partaient dans l'instruction systeme, et 21 sur 69 avaient derive en dix jours (`note` annoncait 105 353 pour 105 493). Une table vide devient « sans donnee au dernier releve, confirme par COUNT(*) ». |
